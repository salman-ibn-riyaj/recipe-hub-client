  ...
  if(recipes.length == 0){
    return (
       <div className="max-w-md mx-auto mt-20 p-8 bg-surface border border-border/70 rounded-2xl text-center shadow-soft space-y-4">
        ...
        <div>
          <h3 className="text-foreground font-semibold text-lg">No Recipe Found</h3>
          <p className="text-muted-foreground text-sm mt-1">There are currently no active Recipe  available.</p>
        </div>
      </div>
    )
  }
